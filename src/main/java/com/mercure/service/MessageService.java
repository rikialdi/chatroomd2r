...
public class MessageService {
    ...
    private static final Map<Long , String> colors = new HashMap<>();
    ...
    public List<MessageEntity> findByGroupId(Long id, Long offset) {
    ...
    public MessageEntity findLastMessage(Long groupId) {
        return messageRepository.findLastMessageByGroupId(groupId);
    }

    public Long findLastMessageIdByGroupId(Long groupId) {
     ...
     * @param group_id Long value for group ID
     * @param message  string for the message content
     * @return a {@link MessageDTO}
     */
    public MessageDTO createMessageDTO(Long id, String type, Long userId, String date, Long group_id, String message) {
    ...
    public MessageDTO createNotificationMessageDTO(MessageEntity msg, Long userId) {
        String groupUrl = groupService.getGroupUrlById(msg.getGroup_id());
