...
public class UserService {
    ...
    private Map<Long , String> wsSessions = new HashMap<>();

    public Map<Long , String> getWsSessions() {
        return wsSessions;
    }

    public void setWsSessions(Map<Long , String> wsSessions) {
...
//    }
    ...
    public Long findUserIdWithToken(String token) {
    ...
    public boolean checkIfUserIsAdmin(Long userId, Long groupIdToCheck) {
